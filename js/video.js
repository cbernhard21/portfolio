var vidyardEmbed = function(e) {
    ...
    var W = ["pardot", "hubspotutk", "_mkto_trk", "vy_dreamforce", "eloqua"],
        z = ["pardot", "hubspot", "marketo", "dreamforce", "eloqua"];
    var H = function() {
    ...
    var X, Z = function(e, t) {
        ...
        Me = function(e, t) {
            ...
            if (o[0] || (o = (a = r, ke(Ne(Oe(a)), !1)).filter(function(e) {
                    var t = e.node;
                    return Fe(t)
                }))[0]) {
        ...
        Ge = function(e) {
            We = e, e && function() {
                ...
                if (We) {
                    var t = We;
                    He() || (t && !we(t) && (e = De(t, ze)), ze = document.activeElement)
                }
            }()
        },
        Je = [],
    ...
    function ht(e, t, n) {
        var r = function(e, t) {
            if ("object" == typeof pt[e.uuid]) return pt[e.uuid][t]
        }(e, t);
        if (void 0 !== r && "object" == typeof r.player.metadata && 0 !== r.thresholds.length) {
            var i = n - r.lastTimeUpdate;
            if (r.lastTimeUpdate = n, !(i <= 0 || i > 1)) {
                r.timeWatched += i;
                for (var o = r.player.metadata.chapters_attributes[t].video_attributes.length_in_seconds, a = r.timeWatched / o * 100; a >= r.thresholds[r.thresholds.length - 1];) r.callback({
                    chapter: t,
    ...
    function vt(e, t, n) {
        var r = e.getCurrentVideoIndex();
        ! function(e, t, n, r) {
            "object" != typeof pt[e.uuid] && (pt[e.uuid] = {}), pt[e.uuid][t] = {
                callback: n,
                lastTimeUpdate: e.currentTime(),
                player: e,
                thresholds: r.slice().sort(function(e, t) {
                    return t - e
                }),
                timeWatched: 0
            }
        ...
        var i = function(t) {
            r === e.getCurrentVideoIndex() && ht(e, r, t)
        };
        return e.on("timeupdate", i), {
            player: e,
            removeEventListeners: function() {
                e.off("timeupdate", i),
                    function(e, t) {
                        "object" == typeof pt[e.uuid] && (pt[e.uuid][t] = void 0)
                    }(e, r)
            }
        }
    }
    ...
    var gt = {
            ...
            integrations: new function() {
                ...
                this.updatePlayer = function(e) {
                    ...
                    for (var r = h(W[z.indexOf(e)], t), i = 0, o = n; i < o.length; i++) {
                        var a = o[i],
                            u = a.indexOf("="),
